...
bool GameUtils::TryHitFromEye(AActor* caster, float lineTraceRange, AActor*& hitActorOut)
{
	FVector EyeLocation;
...
bool GameUtils::TryHitFromEye(AActor* caster, float lineTraceRange, AActor*& hitActorOut, FVector& traceStartOut,
	FVector& traceEndOut)
{
	FVector EyeLocation;
	FRotator EyeRotation;
...
void GameUtils::StoreWidgetAnimations(UObject* widget, TMap<FName, UWidgetAnimation*>& animationsMapOut)
{
